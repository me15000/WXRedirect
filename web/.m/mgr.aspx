            ...
            <table border="0" style="width: 100%">
                <tr>
                    <td style="vertical-align: top">
                        <asp:GridView ID="GV" runat="server" AutoGenerateColumns="False" DataKeyNames="code" DataSourceID="SDS" AllowPaging="True" OnSelectedIndexChanged="GV_SelectedIndexChanged" Width="840px" PageSize="50">
                            <Columns>
